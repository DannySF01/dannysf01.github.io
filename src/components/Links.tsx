...
export default class Links extends Component {
  render() {
    return (
      <div className="fixed w-full py-10 px-10 flex justify-between dark:bg-[#111113] dark:border-[#1f1f22] bg-zinc-50 border-b border-gray-200">
        <a className="flex" href="https://github.com/DannySF01" target="_blank">
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fab"
